...
/* Selecione cada curso e retorne um array com objetos contendo o titulo,
...
const variosNumeros = [3, 44, 333, 23, 122, 322, 33];

const maioresQue100 = variosNumeros.filter((n) => n > 100);
